    ...
    <header class="main-header">
      <div class="container">
        <div class="basic-flex header__top">
          <a href="#" class="logo">
            <img src="img/logo.png" alt="FullProject">
          </a>
          <div class="currencies basic-flex">
            <div class="currency"><span>$</span><span>{{$money['usd']}}</span></div>
            <div class="currency"><span>P</span><span>{{$money['rub']}}</span></div>
            <div class="currency"><span>E</span><span>{{$money['euro']}}</span></div>
          </div>
          <div class="header__actions basic-flex">
            ...
            <div class="languages">
              @if(\App::getLocale()=='ru')
                  ...
                  <ul class="languages__list">
                    <a href="/lang/ru" class="btn language__option language__option--ru" data-status="disabled">РУ</a>
                  </ul>
                  @endif
    ...
    <footer class="footer">
      <div class="container">
        <div class="footer__top basic-flex">
          <a href="#" class="footer_logo"><img src="img/logo-blue.png" alt="FullProject"></a>
