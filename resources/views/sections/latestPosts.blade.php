         ...
         <ul class="news__list basic-flex">
          ...
          <li class="news__item">
            <a href="#"  class="basic-flex news__link">
              <div class="news-image-wrapper"><img src="/admin/images/posts/{{$latestPost->image}}" alt="Bottom Img"></div>
              <div class="news-box basic-flex">
                <h4 class="news__title">{{$latestPost['title_'.\App::getLocale()]}}</h4>
                <p class="news__description">{{\Str::limit($latestPost['body_'.\App::getLocale()],200)}}</p>
